...
void __attribute__((picinterrupt(("")))) TMR0_ISR(void)
{
    if(INTCONbits.TMR0IF == 1)
    {
        ...
        if(cont_sr < data_s[1]){LATDbits.LD1 = 1;} else{LATDbits.LD1 = 0;}



        if(cont_sr < data_s[2]){LATDbits.LD2 = 1;} else{LATDbits.LD2 = 0;}



        if(cont_sr < data_s[3]){LATDbits.LD3 = 1;} else{LATDbits.LD3 = 0;}
# 161 "servo.c"
        TMR0 = 50;
        INTCONbits.TMR0IF = 0;
    }
