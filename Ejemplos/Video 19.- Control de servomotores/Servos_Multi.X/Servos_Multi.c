...
void main()
{
    ...
    while(1)
    {
        ...
        Servo_2_Write(180);             // Servo 2, 180°
        Servo_3_Write(0);               // Servo 3, 0°
        Servo_4_Write(180);             // Servo 4, 180°
        __delay_ms(1000);
        
        Servo_1_Write(180);             // Servo 1, 180°
        Servo_2_Write(0);               // Servo 2, 0°
        Servo_3_Write(180);             // Servo 3, 180°
        Servo_4_Write(0);               // Servo 4, 0°
        __delay_ms(1000);
    }
}